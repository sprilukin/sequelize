  ...
  Query.prototype.run = function(sql) {
    ...
    var promise = new Promise(function(resolve, reject) {
      ...
      if (self.isShowIndexesQuery()) {
        ...
        if (self.instance && result.rowCount === 0 && self.isUpdateQuery()) {
          //this is and update entity query
          //but update query updated 0 rows
          //most likely because of optimising locking
